(function() {
  ...
  Embed = (function(superClass) {
    ...
    Embed.prototype.setupDefaults = function() {
      this.setupEvents();
      this.elements.pre.eachElement(function(element) {
    ...
    Embed.prototype.setupEvents = function() {
      this.elements.actions.eachElement((function(_this) {
    ...
    Embed.prototype.loadResult = function(callback) {
      ...
      iframes.eachElement(function(iframe) {
    ...
    Embed.prototype.switchTab = function(event, action, index) {
      ...
      this.elements.tabs.eachElement(function(element) {
        return element.classList.remove("active");
      });
      this.elements.tabs[index].classList.add("active");
      if (actionParent) {
        actionParent.eachElement(function(element) {
          return element.classList.remove("active");
        });
